...
_0x0:
	...
	.DB  0x0,0x58,0x20,0x77,0x69,0x6E,0x73,0x21
	.DB  0x0,0x4F,0x20,0x77,0x69,0x6E,0x73,0x21
	.DB  0x0,0x44,0x72,0x61,0x77,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 007A             win[r + 3] += game_board[c][r];
	...
	LDI  R27,HIGH(6)
	CALL __MULW12U
	SUBI R30,LOW(-_game_board)
	SBCI R31,HIGH(-_game_board)
	MOVW R26,R30
	MOVW R30,R10
	LSL  R30
	ROL  R31
